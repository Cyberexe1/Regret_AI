...
- **Storage:** Amazon S3 (a dedicated, private evidence bucket is provisioned and IAM-permissioned; the active storage backend today is local disk inside the container — see [Limitations](#future-scope--limitations)).
